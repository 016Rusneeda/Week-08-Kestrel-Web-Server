# ใบงานการทดลองที่ 8.2 (Labsheet 8.2): การสตรีมสัญญาณแอนะล็อก ESP32 ออกพอร์ตสื่อสารอนุกรม (UART)
...
## 🛠️ อุปกรณ์ที่ใช้ในการทดลอง (Hardware Components)
...
2. **ทำไมจึงเลือกใช้ GPIO 34?**
   ...
   - **ADC2** จะถูกระบบ Wi-Fi ยึดครองการใช้งาน เมื่อเปิดใช้งาน Wi-Fi (เช่น ในสัปดาห์หน้าเมื่อต่อ MQTT) จะอ่านค่าไม่ได้
...
2. **วิธีออกจากหน้าจอ Monitor:**
   - กดปุ่ม `Ctrl + ]` (กดปุ่ม Control ค้างไว้แล้วกดเครื่องหมายก้ามปูปิด) เพื่อออกจาก Monitor และปลดล็อกพอร์ต COM
