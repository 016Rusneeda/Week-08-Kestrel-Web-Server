...
> ในสัปดาห์ที่ 8 นี้ การทดลองถูกแบ่งเป็น 4 ใบงานย่อยแบบเป็นลำดับขั้น เพื่อให้นักศึกษาได้ฝึกฝนคำสั่งซ้ำๆ จนเกิดทักษะและความคุ้นเคย **นักศึกษาจะต้องแยกโฟลเดอร์โปรเจกต์เป็น `Lab8-1`, `Lab8-2`, `Lab8-3`, และ `Lab8-4` อย่างเด็ดขาด** ห้ามเขียนโค้ดทับลงในโฟลเดอร์เดิม เพื่อให้ผู้สอนสามารถตรวจเช็คพัฒนาการ (Progression) และประวัติการ Commit แยกแต่ละแล็บได้

2. สร้างโฟลเดอร์สำหรับการทดลองใบงานที่ 8.1 และสร้างโปรเจกต์ Web ว่างเปล่า (Empty Web):
   ```bash
...
4. เปิดเบราว์เซอร์แล้วพิมพ์ URL: `http://localhost:5000`  
   **สิ่งที่เห็น** คำว่า **"Hello World!"** ปรากฏบนหน้าจอทันที!
...
### กิจกรรมที่ 3 C# Object กลายร่างเป็น JSON อัตโนมัติ 
